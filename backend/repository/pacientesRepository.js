     ...
     class PacienteRepository {
       ...
       async findById(id, includePassword = false) {
         const query = includePassword
           ? `SELECT id, cpf, nome, email, senha, data_nascimento, peso_kg, genero, aceite_termos, data_cadastro, ativo, foto_perfil FROM paciente WHERE id = $1`
           : `SELECT id, cpf, nome, email, data_nascimento, peso_kg, genero, aceite_termos, data_cadastro, ativo, foto_perfil FROM paciente WHERE id = $1`;
